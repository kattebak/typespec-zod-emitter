...
- `npm run test:package` — emit, then type-check the emitted package (`tsc -p build/zod-schemas`)
...
- `src/middleware.ts` — HTTP operation map and request-validation middleware generation
